...
\label{J}
\end{equation}
By repeatedly taking the gradient of the objective $\nabla_\phi J(\phi)$, the policy parameters can be continuously updated and push the policy towards optimality. The deterministic policy gradient from \parencite{DPG} can then be defined by the following
